...
@Component
@Slf4j
public class SuccessfulAuthentication extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public SuccessfulAuthentication(@Value("${jwt.expiration}") int expTime,
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        String token = JWT.create()
                .withSubject(accountService.getAccountInfo(principal.getUsername()).getUsername())
